...
def get_summary(page_content):
    summary = model.generate_content(f'summarize reviews and provide insights into viewer opinions, popular themes, and ratings. within 300 words , the review page content of movie review page is : {page_content}').text
    return summary
